...
| **Playing** | Lo que estás jugando (`games.playing`), como lista de catálogo. Desde 600dp de ancho, año y región en columna aparte | Modal: **física** (del catálogo) o **digital** (SteamGridDB) |
